                ...
                <div class="content-panel">
                    ...
                    <form class="form-horizontal">
                        <fieldset class="fieldset">
                            <h3 class="fieldset-title">Create Your Profile</h3>
                                     ...
                                     $res = mysqli_query($connection,$query);
                                       if(mysqli_num_rows($res)==1)
                                       {
                                          ...
                                          echo' <div class="form-group">';
                                           echo'<label class="col-md-2 col-sm-3 col-xs-12 control-label">';echo'User Name</label>';
                                           echo'<div class="col-md-10 col-sm-9 col-xs-12">';
                                              echo' <input type="text" name="Username" class="form-control" value="<?php echo $Username;?>">';
                                          echo' </div>';
                                           echo' </div>;';
                            ...
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">Weight</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    <input type="text" name="Weight" class="form-control" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">Height</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-md-10 col-sm-9 col-xs-12 col-md-push-2 col-sm-push-3 col-xs-push-0">
                                <input class="btn btn-primary" style="background-color:#d291bc;"type="submit" value="Create">
                            </div>
                        </div>
...
<!-- subscribe and footer -->
 ...
 <footer class="footer-master" style=" padding: 90px 0px;">
  ...
  {   
      ...
      $query = "INSERT INTO User VALUES('','','','',$_POST[Weight]','$_POST[Height]','1','''','','','')";
