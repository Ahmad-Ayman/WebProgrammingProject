...
<html>
    <head>
        <meta charset="UTF-8">
        <title></title>
        <script src="https://kit.fontawesome.com/b372ba7dd9.js"></script>
...
<section class="my-5">
  ...
  <!-- Section heading -->
  <h2 class="h1-responsive font-weight-bold text-center my-5">Why With Us Is So Great?</h2>
  <!-- Section description -->
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="row mb-3">
        ...
        <!-- Grid column -->
        <div class="col-10">
          <h5 class="font-weight-bold mb-3">ACHIEVE YOUR PERFECT BODY</h5>
    ...
    <div class="col-md-4 text-center">
        <img class="img-fluid" src="images/program-6.jpg"
        alt="Sample image">
    </div>
    <!-- Grid column -->
    ...
    <div class="col-md-4">
      ...
      <div class="row mb-3">
        ...
        <!-- Grid column -->
        <div class="col-10">
          <h5 class="font-weight-bold mb-3">ANALYZE YOUR GOAL</h5>
          <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores
            nam, aperiam minima assumenda deleniti hic.</p>
        </div>
        <!-- Grid column -->
      ...
      <div class="row mb-3">
        ...
        <!-- Grid column -->
        <div class="col-10">
          <h5 class="font-weight-bold mb-3">WORK HARD ON IT</h5>
          <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores
            nam, aperiam minima assumenda deleniti hic.</p>
        </div>
        <!-- Grid column -->
      ...
      <div class="row">
        ...
        <!-- Grid column -->
        <div class="col-10">
          <h5 class="font-weight-bold mb-3">IMPROVE YOUR PERFORMANCE</h5>
...
<!-- Section: Features v.4 -->
    ...
    <center><h1>Access Location</h1></center>
...
<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA4QMT9idC_poPK_9CWR0PKzWvAUd4PC38&callback=initMap"
    async defer></script>
    -->
